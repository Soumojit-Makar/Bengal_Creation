...
import { addContactMessage } from "../api/api";
...
function ContactPage({ onShowToast }) {
  ...
  const submit = async () => {
    ...
    if (!emailOk) { onShowToast("⚠️ Please enter a valid email address"); return; }
  ...
  return (
    <div className="bgabout">
      ...
      <div style={{ maxWidth: 1100, margin: "40px auto", padding: "0 20px", display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(350px, 1fr))", gap: 30 }}>
        <div>
          {sent ? (
        ...
        <div>
          <div className="contact-card">
            <h3>📍 Our Office</h3>
            <p>Digital Indian EN-9, Sector V, Salt Lake <br />Kolkata, West Bengal <br />India - 700091</p>
          </div>
          <div className="contact-card">
            <h3>📞 Call Us</h3>
          ...
          <iframe
            ...
            width="100%" height="200" style={{ border: 0, borderRadius: 12, marginTop: 15 }} loading="lazy"
          />
        </div>
      </div>
    </div>
